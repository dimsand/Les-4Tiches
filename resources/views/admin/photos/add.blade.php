...
@section('content')
    ...
    <div id="my_modal" class="">
        ...
        <div class="slideshow-container-no-images" style="<?=(!empty($files['images'])) ? 'display: none;' : ''?>">
            ...
            <div><button class="btn btn-default btn-show-photos-content"><i class="fa fa-picture-o"></i> Des images</button></div>
        </div>

        <div class="photos-content" style="<?=(!empty($files['images']) && !empty($files['docs'])) ? 'display: none;' : ''?>">
            <div class="title-type-file"><i class="fa fa-picture-o"></i> Ajouter des images</div>
...
@section('javascript')
    ...
    <script>
        $(function () {
            ...
            $( document ).on('click', ".btn-show-photos-content", function() {
                $(".add-files-container, .add-files-container i").dropzone(optionsDropzone);
                $('.photos-content').show();
            });
