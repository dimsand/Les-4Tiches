                        ...
                        <tr>
                            <td style="padding: 40px 40px 20px; text-align: center;">
                                <h1 style="margin: 0; font-family: 'Selima'; font-size: 24px; line-height: 125%; color: #ffbd4a; font-weight: normal; border: #ff5c5c solid 3px; padding: 16px;">
                                    <img src="{{ $message->embed(public_path() . '/img/2-transparent-sm.png') }}" height="25" alt="" border="0" style="height: 25px !important; font-size: 20px; line-height: 140%; border-radius: 50%;"/>
                        ...
                        <tr>
                            <td style="padding: 20px; text-align: center; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #ffffff;">
                                <p style="margin: 0;">Copyrights Les 4Tiches 2018
                                    <a href="https://www.facebook.com/Les4Tiches/"><img src="{{ $message->embed(public_path() . '/img/facebook-sm.png') }}" height="25" alt="" border="0" style="height: 25px !important; font-size: 20px; line-height: 140%; border-radius: 50%;"/></a>
                                </p>
                            </td>
                        </tr>
                    </table>
